...
<input class="widefat" id="<?php echo $field_ids[ 'author_label' ]; ?>" name="<?php echo $this->get_field_name( 'author_label' ); ?>" type="text" value="<?php echo esc_attr( $author_label ); ?>" placeholder="<?php echo $this->defaults[ 'author_label' ]; ?>" /><br />
...
<input class="widefat" id="<?php echo $field_ids[ 'category_label' ]; ?>" name="<?php echo $this->get_field_name( 'category_label' ); ?>" type="text" value="<?php echo esc_attr( $category_label ); ?>" placeholder="<?php echo $this->defaults[ 'category_label' ]; ?>" /><br />
<em><?php esc_html_e( 'This field can be empty.', 'recent-posts-widget-with-thumbnails' );?> <?php esc_html_e( 'A space will be added automatically between the label and the name.', 'recent-posts-widget-with-thumbnails' );?></em></p>
